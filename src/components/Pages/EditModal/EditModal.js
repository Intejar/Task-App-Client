        ...
        <div className="space-y-6 px-6 pb-4 sm:pb-6 lg:px-8 xl:pb-8">
          ...
          <form onSubmit={handleEdit} className="">
            <input
              ...
              type="text"
              id="first_name"
              className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg text-center w-full"
            ...
            <input
              ...
              type="text"
              id=""
              className="my-3 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg text-center w-full"
          ...
          <div className="flex flex-col gap-4" id="checkbox">
            {info?.check?.map((check) => (
              <div className="flex items-center gap-2">
                ...
                <Label htmlFor="promotion">{check}</Label>
              </div>
            ))}
          </div>
        </div>
